...
campos_Threonine_timecourses <- read.csv("campos_Threonine.txt", sep="\t")
ggplot(data=campos_Threonine_timecourses, aes(x=CT, y=Threonine, group=Campo)) +
...
campos_Threonine <- ggplot(data=campos_Threonine_timecourses, aes(x=CT, y=Threonine, group=Campo)) +
...
campos_Serine_timecourses <- read.csv("campos_Serine.txt", sep="\t")
ggplot(data=campos_Serine_timecourses, aes(x=CT, y=Serine, group=Campo)) +
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)
fit2 <- data.frame(fit2)
fit3 <- fit2[1:80, ]
...
campos_Serine <- ggplot(data=campos_Serine_timecourses, aes(x=CT, y=Serine, group=Campo)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)+
...
campos_Tagatose_timecourses <- read.csv("campos_Tagatose.txt", sep="\t")
ggplot(data=campos_Tagatose_timecourses, aes(x=CT, y=Tagatose, group=Campo)) +
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)
fit2 <- data.frame(fit2)
fit3 <- fit2[1:80, ]
...
campos_Tagatose <- ggplot(data=campos_Tagatose_timecourses, aes(x=CT, y=Tagatose, group=Campo)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)+
...
campos_Oxoproline_timecourses <- read.csv("campos_Oxoproline.txt", sep="\t")
ggplot(data=campos_Oxoproline_timecourses, aes(x=CT, y=Oxoproline, group=Campo)) +
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)
fit2 <- data.frame(fit2)
fit3 <- fit2[1:80, ]
...
campos_Oxoproline <- ggplot(data=campos_Oxoproline_timecourses, aes(x=CT, y=Oxoproline, group=Campo)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)+
...
plot_grid(campos_Threonine, campos_Serine, campos_Tagatose, campos_Oxoproline,  labels = c("A","B","C","D"), ncol = 2, align = "none", rel_widths = c(1.2, 1),rel_heights = c(1,1.1),label_size = 20)
