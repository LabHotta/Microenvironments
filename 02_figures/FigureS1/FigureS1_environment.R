...
#FigureS1A
sugarcane4mo9mo = read.csv("FigureS1_4mo9mo_environment.txt", sep="\t")

light_daily_4mo9mo <- ggplot(data=sugarcane4mo9mo, aes(x=CT, y=Light, group=Sampling)) +
...
#FigureS1B
temperature_daily_4mo9mo <- ggplot(data=sugarcane4mo9mo, aes(x=CT, y=Temperature, group=Sampling)) +
...
#FigureS1C
EW <- read.csv("FigureS1_EW_environment.txt", sep="\t")

light_daily_margin <- ggplot(data=EW, aes(x=CT, y=Light, group=Sampling)) +
...
#FigureS1D
temperature_daily_margin <- ggplot(data=EW, aes(x=CT, y=Temperature, group=Sampling)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = 5, ymax = 50, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = 5, ymax = 50, alpha = .5, fill = "#e3e3e3")+
  #geom_line(aes(colour=Sampling, linetype=Sampling), size = 1.2) +
  geom_jitter(aes(col=Sampling, shape = Sampling),position=position_jitter(0.2), size = 3) +
...
#FigureS1E
wall <- read.csv("FigureS1_wall_environment.txt", sep="\t")

light_daily_wall <- ggplot(data=wall, aes(x=CT, y=Light, group=Sampling)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = -0.5, ymax = 4.5, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = -0.5, ymax = 4.5, alpha = .5, fill = "#e3e3e3")+
  #geom_line(aes(colour=Sampling, linetype=Sampling), size = 1.2) +
  geom_jitter(aes(col=Sampling, shape = Sampling),position=position_jitter(0.2), size = 3) +
...
#FigureS1F
temperature_daily_wall <- ggplot(data=wall, aes(x=CT, y=Temperature, group=Sampling)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = 5, ymax = 50, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = 5, ymax = 50, alpha = .5, fill = "#e3e3e3")+
  #geom_line(aes(colour=Sampling, linetype=Sampling), size = 1.2) +
  geom_jitter(aes(col=Sampling, shape = Sampling),position=position_jitter(0.2), size = 3) +
...
plot_grid(light_daily_4mo9mo, temperature_daily_4mo9mo, light_daily_margin, temperature_daily_margin, light_daily_wall, temperature_daily_wall, labels = c("A", "B","C", "D","E", "F"), ncol= 2, align = "v",rel_heights = c(1,1,1.15),label_size = 20)
