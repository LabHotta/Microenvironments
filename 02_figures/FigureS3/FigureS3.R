...
#Figure S6A
ritmicos = read.csv("FigureS3_Expressed_rhythmic.txt", sep="\t")
...
#Figure S6B
annotation <- read.csv("FigureS3_Annotation_expressed_abs.txt", sep="\t")
...
#Figure S6B
annotation <- read.csv("FigureS3_Annotation_rhythmic_abs.txt", sep="\t")
annotation$Pathway <- factor(annotation$Pathway,levels = c("Transcription Factors", "Protein Degradation", 
                                                           "Protein Synthesis",  "RNA degradation", 
                                                           "RNA synthesis and processing", "DNA replication",
                                                           "Chromatin remodelling", "Vesicle Trafficking", 
...
#Figure S6C
phase <- read.csv("FigureS3_phase_distribution.txt", sep="\t")
