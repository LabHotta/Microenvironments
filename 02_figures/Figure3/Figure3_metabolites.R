...
#Figure3A
C1_PCA0 <- read.csv("Figure3_C1_PCA_t.txt", sep="\t")
...
C2_PCA0 <- read.csv("Figure3_C2_PCA_t.txt", sep="\t")
...
#Figure3B
phase_aas0 <- read.csv("Figure3_phase_aas.txt", sep="\t")
...
#Figure3C
campos_Sucrose_timecourses <- read.csv("Figure3_campos_Sucrose.txt", sep="\t")
ggplot(data=campos_Sucrose_timecourses, aes(x=CT, y=Sucrose, group=Campo)) +
...
campos_Sucrose <- ggplot(data=campos_Sucrose_timecourses, aes(x=CT, y=Sucrose, group=Campo)) +
...
#Figure3D
campos_Tyrosine_timecourses <- read.csv("Figure3_campos_Tyrosine.txt", sep="\t")
ggplot(data=campos_Tyrosine_timecourses, aes(x=CT, y=Tyrosine, group=Campo)) +
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)
fit2 <- data.frame(fit2)
fit3 <- fit2[1:80, ]
...
campos_Tyrosine <- ggplot(data=campos_Tyrosine_timecourses, aes(x=CT, y=Tyrosine, group=Campo)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)+
...
#Figure3E
campos_Alanine_timecourses <- read.csv("Figure3_campos_Alanine.txt", sep="\t")
ggplot(data=campos_Alanine_timecourses, aes(x=CT, y=Alanine, group=Campo)) +
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)
fit2 <- data.frame(fit2)
fit3 <- fit2[1:80, ]
...
campos_Alanine <- ggplot(data=campos_Alanine_timecourses, aes(x=CT, y=Alanine, group=Campo)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)+
...
#Figure3F
campos_Glutamate_timecourses <- read.csv("Figure3_campos_Glutamate.txt", sep="\t")
ggplot(data=campos_Glutamate_timecourses, aes(x=CT, y=Glutamate, group=Campo)) +
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)
fit2 <- data.frame(fit2)
fit3 <- fit2[1:80, ]
...
campos_Glutamate <- ggplot(data=campos_Glutamate_timecourses, aes(x=CT, y=Glutamate, group=Campo)) +
  annotate("rect", xmin = -2, xmax = 0, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  annotate("rect", xmin = 12, xmax = 24, ymin = -3, ymax = 3, alpha = .5, fill = "#e3e3e3")+
  geom_jitter(aes(col=Campo, shape = Campo),position=position_jitter(0.2), size = 3) +
  stat_smooth(aes(group = Campo, colour = Campo, fill=Campo, outfit=fit2<<-..y..),method="loess",  span = 0.5)+
...
#4.803544 24.52 16.93937 4.015063

#Figure3G
cartoon_4mo <- cowplot::ggdraw() + cowplot::draw_image("Figure3_cartoon_C1.png", scale = 0.9)
cartoon_9mo <- cowplot::ggdraw() + cowplot::draw_image("Figure3_cartoon_C2.png", scale = 0.9)


panelA <- plot_grid(C1_PCA, C2_PCA, labels = c(" ", ""), ncol = 1, align = "none", rel_widths = c(1, 1),rel_heights = c(1,1),label_size = 20)
panelA

panelsAB <- plot_grid(panelA, phase_shift, labels = c("A", "B"), ncol = 2, align = "none", rel_widths = c(1, 1),rel_heights = c(1,1),label_size = 20)
panelsAB

panelCDEF <- plot_grid(campos_Sucrose, campos_Tyrosine, campos_Alanine, campos_Glutamate, labels = c("C", "D","E", "F" ), ncol = 2, align = "none", rel_widths = c(1.25, 1),rel_heights = c(1,1.15),label_size = 20)
panelCDEF

panelG <- plot_grid(cartoon_4mo, cartoon_9mo, labels = c(" ", ""), ncol = 1, align = "none", rel_widths = c(1, 1),rel_heights = c(1,1),label_size = 20)
panelG

panelCDEFG <- plot_grid(panelCDEF, panelG, labels = c(" ", "G"), ncol = 2, align = "none", rel_widths = c(1, 1),rel_heights = c(1,1),label_size = 20)
panelCDEFG 

#all
plot_grid(panelsAB, panelCDEFG, labels = c("", ""), ncol = 1, align = "none", rel_widths = c(1, 1),rel_heights = c(1,1),label_size = 20)
