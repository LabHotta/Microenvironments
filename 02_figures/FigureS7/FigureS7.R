...
#Figure S7A
timecourses_LHY <- read.csv("FigureS7_LHY_timecourses.txt", sep="\t")
...
#Figure S7B
timecourses_TOC1 <- read.csv("FigureS7_TOC1_timecourses.txt", sep="\t")
...
#Figure S7C
timecourses_GI <- read.csv("FigureS7_GI_timecourses.txt", sep="\t")
...
#Figure S7D
timecourses_PRR73 <- read.csv("FigureS7_PRR73_timecourses.txt", sep="\t")
...
#Figure S7C
timecourses_PRR59 <- read.csv("FigureS7_PRR59_timecourses.txt", sep="\t")
...
#Figure S7C
timecourses_PRR95 <- read.csv("FigureS7_PRR95_timecourses.txt", sep="\t")
...
#Figure S7C
timecourses_RVE8 <- read.csv("FigureS7_RVE8_timecourses.txt", sep="\t")
...
#Figure S7C
timecourses_GDH1 <- read.csv("FigureS7_GDH1_timecourses.txt", sep="\t")
